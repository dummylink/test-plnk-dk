...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../../fpga/altera/BeMicro/ink_pcp_DirectIO_10_2/nios_openMac.jdi
...
# Design Name 
# setting SOPC_NAME is niosII_openMac
SOPC_NAME := niosII_openMac
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x998
SOPC_SYSID_FLAG += --sidp=0x998
ELF_PATCH_FLAG  += --sidp 0x998

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1334729853
SOPC_SYSID_FLAG += --timestamp=1334729853
ELF_PATCH_FLAG  += --timestamp 1334729853
